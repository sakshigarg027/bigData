...
class MainHandler(BaseHandler):
    ...
    def get(self):
        ...
        # (by default) for dogs.
        feed = feedparser.parse("http://pipes.yahoo.com/pipes/pipe.info?_id=a53781cecaa2acb4c85ecf115692987f&_render=rss&textinput1=dogs" )
    ...
    def post(self):
        ...
        feed = feedparser.parse("http://pipes.yahoo.com/pipes/pipe.info?_id=a53781cecaa2acb4c85ecf115692987f&_render=rss&textinput1=" + terms )
